...
(define-key global-map (kbd "C-k C-k") 'kill-line)
(define-key global-map (kbd "C-k C-a") 'mark-whole-buffer)
(define-key global-map (kbd "C-k C-r") 'replace-string)
(define-key global-map (kbd "C-k C-p") 'markdown-grip-preview)
(define-key global-map (kbd "C-k C-m") 'markdown-marp-preview)
(define-key global-map (kbd "C-k C-t") 'ctags-create-or-update-tags-table)
(define-key global-map (kbd "C-k C-c") 'kill-all-buffers)
